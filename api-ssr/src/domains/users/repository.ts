...
export function createInMemoryUserRepository(): UserRepository {
  const users = new Map<string, User>([
    ['1', { id: '1', name: 'Ada Lovelace', email: 'ada@northstar.example', role: 'operator', version: 1 }],
    ['2', { id: '2', name: 'Grace Hopper', email: 'grace@northstar.example', role: 'viewer', version: 1 }],
  ]);
