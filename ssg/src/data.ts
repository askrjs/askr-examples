...
export const runbooks: Runbook[] = [
  {
    ...
    steps: ['Confirm the readiness probe is failing.', 'Shift traffic to the healthy region.', 'Verify request IDs in the access log.'],
  },
  {
    slug: 'policy-rollback',
    title: 'Policy rollback',
    summary: 'Return an invalid access policy to the last verified revision.',
    steps: ['Pause policy publication.', 'Restore the previous policy version.', 'Run the permission verification checks.'],
  },
];
